        ...
        BigInteger j = new BigInteger("100000000000");
            ...
            for (int i = 0; i < externalUsersJson.length(); i++) {
                ...
                externalUsers.add(new String[] {
                        ...
                        externalUsersJson.getJSONObject(i).getJSONObject("name").getString("first") + " " + externalUsersJson
                                .getJSONObject(i)
                                .getJSONObject("name")
                                .getString("last"),
                        externalUsersJson.getJSONObject(i).getJSONObject("location").getString("country"),
                        String.valueOf(externalUsersJson.getJSONObject(i).getJSONObject("location").get("postcode")),
